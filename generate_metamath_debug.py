...
def main():
    ...
    args = [
    "--model_name_or_path", "/root/OVM/models/gsm8k/generators/opt-125mln-gen",
    "--dataset", "gsm8k",
    "--data_dir", "data/gsm8k",
    "--output_dir", "/root/OVM/data/gsm8k/model_generation",
    "--metric_output_dir", "/root/OVM/eval_results/gsm8k/generator",
    "--target_set", "train_small",
    "--n_solutions", "5",  # Assuming n_solutions is a variable you have defined elsewhere
    "--batch_size", "4",
    "--do_sample", "True",
    "--temperature", "0.7",
    "--top_k", "50",
